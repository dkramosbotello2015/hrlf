            ...
            @foreach ($usuarios as $users)
             <tr>
                 ...
                 <td>
                    ...
                    <a href="{{ url('editarusuario/'.$users->correo.'/'.$users->clave.'/') }}">
                        <button type="submit" class="btn btn-primary">EDITAR</button> &nbsp;&nbsp;&nbsp;
                    </a>

                    <a href="{{ url('asignacionusuarios/'.$users->idusuario.'/') }}">
                        <button type="submit" class="btn btn-warning">Asociados</button>
                    </a>
