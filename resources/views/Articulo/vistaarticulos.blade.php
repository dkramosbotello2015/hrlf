            ...
            @foreach ($Articulos as $articulo)
             <tr>
                 ...
                 <td>
                    ...
                    <a href="{{ url('mantenimientoarticulo/'.$articulo->idarticulo.'/') }}">
                        <button type="submit" class="btn btn-warning">Asignar Entrada</button>
                    </a>

                    <a href="{{ url('kardex/'.$articulo->idarticulo.'/') }}">
                        <button type="submit" class="btn btn-warning">KARDEX</button>
                    </a>
